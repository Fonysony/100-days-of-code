...
- I didn't get much done, but worked on [Search Insert Position](https://leetcode.com/problems/search-insert-position/) Leetcode problem. I was able to do this problem in C++! I'm attemping to do the problem in JavaScript and then apply in C++ just to get my feet wet with C++.
- Worked on Khan Academy's arithmetic section, but to much to really say that I got done.

**What I Learned:**

- I seriously gotta be more consistent with what I'm doing.
...
- Found a cool Neovim plugin called coc which brings LSP for multiple files just like in VS-Code.
